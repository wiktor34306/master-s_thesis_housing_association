...
import './ConfirmationOfAdRemovalModalAdminStyle.css';

export const ConfirmationOfAdRemovalModalAdmin = ({ 
  isOpen, 
  handleClose, 
  advertisementId, 
  onDeleteSuccess 
  ...
  return (
    ...
    >
      <Box className="confirm-delete-advertisement-admin-modal">
        <h2 id="confirm-delete-advertisement-title">
          Czy na pewno chcesz usunąć to ogłoszenie?
        </h2>
        <div className="confirmation-buttons">
          <Button
            id="confirm-yes-button-remove-adv-admin"
            variant="contained"
            color="primary"
