...
import './ConfirmationOfEventsRemovalModalAdminStyle.css';

export const ConfirmationOfEventsRemovalModalAdmin = ({ 
  isOpen, 
  handleClose, 
  eventId, 
  onDeleteSuccess 
  ...
  return (
    ...
    >
      <Box className="confirm-delete-event-admin-modal">
        <h2 id="confirm-delete-event-title">
          Czy na pewno chcesz usunąć to wydarzenie?
        </h2>
        <div className="confirmation-buttons-event-removal-admin">
          <Button
            id="confirm-yes-button-remove-event-admin"
            variant="contained"
            color="primary"
