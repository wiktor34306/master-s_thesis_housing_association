...
import './AddWorkerFormAdminStyle.css';

export const AddWorkerFormAdmin = () => {
    ...
    fetch(`${config.BASE_URL}/my-housing-association`, {
      ...
      .then((response) => {
        if (response.status === 403) {
          console.warn("Otrzymano 403 – admin główny, brak przypisanej spółdzielni");
              ...
              <div className="form-add-worker">
                <div className="form-add-worker-container">
                  <form onSubmit={handleSubmit} className="add-advertisement-form">
                    <div className="form-group-add-worker-admin">
                      <label htmlFor="imie">Imię</label>
                      <br />
                      <input
                        type="text"
                        id="imie"
                        className="input-form-add-worker-admin"
                        value={imie}
                        onChange={(e) => {
                    ...
                    {userHA && userHA.housing_association_id === null ? (
                      <div className="form-group-add-worker-admin">
                        <label htmlFor="housing_association_id">Wybierz spółdzielnię</label>
                        <br />
                        <select
                    ...
                    <div className="form-actions">
                      <button type="submit" className="submit-button-form-add-worker-admin">
                        Dodaj pracownika
                      </button>
                    </div>
                  </form>
