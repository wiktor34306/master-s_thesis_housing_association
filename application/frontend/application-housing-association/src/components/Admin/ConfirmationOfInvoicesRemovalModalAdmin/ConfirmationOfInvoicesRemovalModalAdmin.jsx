...
import "./ConfirmationOfInvoicesRemovalModalAdminStyle.css";

export const ConfirmationOfInvoicesRemovalModalAdmin = ({ 
  isOpen, 
  handleClose, 
  documentId, 
  onDeleteSuccess 
  ...
  return (
    ...
    >
      <Box className="confirm-delete-invoices-admin-modal">
        <h2 id="confirm-delete-invoice-title">
          Czy na pewno chcesz usunąć tę fakturę?
        </h2>
        <div className="confirmation-buttons-invoices-removal-admin">
          <Button
            id="confirm-yes-button-remove-invoice-admin"
            variant="contained"
            color="primary"
