...
import './EditAdvertisementModalAdminStyle.css';

export const EditAdvertisementModalAdmin = ({ isOpen, handleClose, advertisement, onSave }) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (typeof onSave === 'function') {
          onSave({ ...advertisement, title, content });
        }
        handleClose(); 
      } else {
  ...
  return (
    ...
    >
      <Box className="edit-advertisement-modal-admin">
        ...
        <form onSubmit={handleSubmit} className="edit-advertisement-form">
          <div className="form-group-admin-advertisement">
            ...
            <input
              type="text"
              id="edit-title"
              className="input-form-edit-advertisement-admin"
              value={title}
          ...
          <div className="edit-adv-form-actions-admin">
            <Button 
              id="edit-accept-button-admin"
              type="submit"
