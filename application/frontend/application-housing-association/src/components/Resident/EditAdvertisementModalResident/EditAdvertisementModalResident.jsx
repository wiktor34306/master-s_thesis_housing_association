...
import './EditAdvertisementModalResidentStyle.css';

export const EditAdvertisementModalResident = ({ isOpen, handleClose, advertisement, onUpdate }) => {
  ...
  return (
    ...
    >
      <Box className="edit-advertisement-modal-resident">
        ...
        <form onSubmit={handleSubmit} className="edit-advertisement-form">
          <div className="form-group-admin-advertisement">
            ...
            <input
              type="text"
              id="edit-title"
              className="input-form-edit-advertisement-resident"
              value={title}
          ...
          <div className="edit-adv-form-actions-resident">
            <Button 
              id="edit-accept-button-resident"
              type="submit"
