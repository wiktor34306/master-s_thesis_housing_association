...
import "./BrowseAllInvoicesWorkerStyle.css";
import { getUserRole } from "../../../getUserRole";
import { HiArrowDownTray } from "react-icons/hi2"; 
import { ConfirmationOfInvoicesRemovalModalWorker } from "../ConfirmationOfInvoicesRemovalModalWorker/ConfirmationOfInvoicesRemovalModalWorker";

export const BrowseAllInvoicesWorker = () => {
  ...
  const InvoiceCard = ({ invoice }) => {
    return (
      <div className="browse-invoices-worker-card">
        <h3>{invoice.name}</h3>
        <p>
        ...
        <div className="invoices-button-row-worker">
          <button
            className="button-browse-invoices-worker"
    ...
    <>
      <div className="start-window-admin-container">
        ...
        <div className="start-window-admin-content">
          <div className="browse-invoices-section-worker">
            <div className="browse-invoices-edit-section-worker">
              <h2>Przeglądanie faktur</h2>
              <div className="browse-invoices-grid-worker">
                <div className="browse-invoices-grid-worker-container">
            ...
            <div className="pagination-browse-invoices-worker-grid">
              {Array.from({ length: totalPages }, (_, idx) => idx + 1).map(
                (number) => (
                  <button
                    id="number-of-pagination-browse-invoices-grid-worker"
                    key={number}
      ...
      <ConfirmationOfInvoicesRemovalModalWorker 
