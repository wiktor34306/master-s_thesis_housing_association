      ...
      <header>
        <div className="worker-navbar-container">
          <div className="worker-navbar">
            <div className="worker-navbar-logo">
              <Link to="/homepageworker">
                <img src={LogoIcon} alt="Logo" width="160" height="60" />
              </Link>
            </div>

            <div className="worker-navbar-center"></div>

            <div className="worker-navbar-menu">
              <nav>
                <ul className={isOpen ? "worker-nav-link active" : "worker-nav-link"}>                
                  <li>
                    <a href="#">Konto</a>
                    <ul className="worker-submenu">
                      <li>
                        <Link to="/add-worker-form-worker" onClick={() => setIsOpen(false)}>
                          Dodaj pracownika spółdzielni
                        </Link>
                      </li>
                      <li>
                        <Link to="/add-resident-form-worker" onClick={() => setIsOpen(false)}>
                          Dodaj mieszkańca spółdzielni
                        </Link>
                      </li>
                      <li>
                        <Link to="/browse-all-users-worker" onClick={() => setIsOpen(false)}>
                  ...
                  <li>
                    ...
                    <ul className="worker-submenu">
                      <li>
                        <Link to="/add-event-to-calendar-worker" onClick={() => setIsOpen(false)}>
                          Dodaj wydarzenie
                        </Link>
                      </li>
                      <li>
                        <Link to="/browse-events-worker" onClick={() => setIsOpen(false)}>
                  ...
                  <li>
                    ...
                    <ul className="worker-submenu">
                      <li>
                        <Link to="/browse-reports-worker" onClick={() => setIsOpen(false)}>
                  ...
                  <li>
                    ...
                    <ul className="worker-submenu">
                      <li>
                        <Link to="/add-advertisement-form-worker" onClick={() => setIsOpen(false)}>
                          Dodaj ogłoszenie
                        </Link>
                      </li>
                      <li>
                        <Link to="/advertisement-setting-grid-worker" onClick={() => setIsOpen(false)}>
                    ...
                    <li>
                      ...
                      <ul className="worker-submenu">
                        <li>
                          <Link to="/generate-invoice-pdf-worker" onClick={() => setIsOpen(false)}>
                            Dodaj dokument
                          </Link>
                        </li>
                        <li>
                          <Link to="/browse-all-invoices-worker" onClick={() => setIsOpen(false)}>
                  ...
                  <li>
                    ...
                    <ul className="worker-submenu">
                      ...
                      <li>
                        <Link to="/edit-user-worker" onClick={() => setIsOpen(false)}>
                ...
                <div className="worker-navbar-icon" onClick={toggleMenu}>
                  <FaBars />
                </div>
              </nav>
            </div>
