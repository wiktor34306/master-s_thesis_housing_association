...
import "./BrowseEventsWorkerStyle.css";
import { ConfirmationOfEventsRemovalModalWorker } from "../ConfirmationOfEventsRemovalModalWorker/ConfirmationOfEventsRemovalModalWorker";
import { EditEventFormModalWorker } from "../EditEventFormModalWorker/EditEventFormModalWorker";

export const BrowseEventsWorker = () => {
  ...
  return (
    <>
      <ConfirmationOfEventsRemovalModalWorker
      ...
      <div className="start-window-admin-container">
        ...
        <div className="start-window-admin-content">
          <div className="browse-events-section-worker">
            <div className="browse-events-worker-section">
              <h2>Kalendarz wydarzeń</h2>
              <div className="calendar-container-worker">
                <Calendar
              ...
              <div className="events-list-section-worker">
                <h3>Lista wydarzeń dla dnia {date.toLocaleDateString()}</h3>
                {filteredEvents.length === 0 ? (
                  <p>Brak wydarzeń do wyświetlenia.</p>
                ) : (
                  filteredEvents.map((event) => (
                    <div key={event.event_id || event.id} className="event-item-worker">
                      <p>
                      ...
                      <div className="event-actions-worker">
                        <button
                          className="button-browse-events-worker"
