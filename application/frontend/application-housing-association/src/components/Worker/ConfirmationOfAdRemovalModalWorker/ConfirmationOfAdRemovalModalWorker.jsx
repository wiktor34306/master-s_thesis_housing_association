...
import './ConfirmationOfAdRemovalModalWorkerStyle.css';

export const ConfirmationOfAdRemovalModalWorker = ({ 
  isOpen, 
  handleClose, 
  advertisementId, 
  onDeleteSuccess 
  ...
  return (
    ...
    >
      <Box className="confirm-delete-advertisement-worker-modal">
        <h2 id="confirm-delete-advertisement-title">
          Czy na pewno chcesz usunąć to ogłoszenie?
        </h2>
        <div className="confirmation-buttons-worker">
          <Button
            id="confirm-yes-button-remove-adv-worker"
            variant="contained"
            color="primary"
