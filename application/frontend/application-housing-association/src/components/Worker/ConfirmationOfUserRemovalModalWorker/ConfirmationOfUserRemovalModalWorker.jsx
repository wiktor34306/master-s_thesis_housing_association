...
import './ConfirmationOfUserRemovalModalWorkerStyle.css';

export const ConfirmationOfUserRemovalModalWorker = ({ 
  isOpen, 
  handleClose, 
  userId, 
  onDeleteSuccess 
  ...
  return (
    ...
    >
      <Box className="confirm-delete-user-worker-modal">
        <h2 id="confirm-delete-user-title">
          Czy na pewno chcesz usunąć tego użytkownika?
        </h2>
        <div className="confirmation-buttons-delete-user-worker">
          <Button
            id="confirm-yes-button-remove-user-worker"
            variant="contained"
            color="primary"
